    ...
    try: 
        ...
        while True:
            ...
            if prompt.lower() == "quit":
                ...
                # Orange - Get a response to image input - from an image URL
                image_url = "https://github.com/Cadetto92/mslearn-ai-vision/blob/main/Labfiles/gen-ai-vision/orange.jpeg?raw=true"
                #image_url = "https://microsoftlearning.github.io/mslearn-ai-vision/Labfiles/gen-ai-vision/orange.jpeg"

                # Mystery-Fruit - Get a response to image input - from a raw data URL
